...
$razorpay_test_key='rzp_test_5DaZ5gHzEKNQH2'; //Your Test Key
$razorpay_test_secret_key='4c6VMJS2A9OlfEs7K3MxiBlZ'; //Your Test Secret Key
...
echo json_encode(['res'=>'success','order_number'=>$order_id,'userData'
=>$dataArr,'razorpay_key'=>$razorpay_key]); exit;
}else{
